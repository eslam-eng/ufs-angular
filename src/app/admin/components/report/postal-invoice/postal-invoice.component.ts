...
@Component({
  ...
  templateUrl: './postal-invoice.component.html',
  styleUrls: ['./postal-invoice.component.scss']
})
export class PostalInvoiceComponent implements OnInit {

  baseApiUrl: any = "report/awb-prices3";
  title: any = "";
  status: any = [];
  breadcrumbList: any = [];
  companies: any = [];
