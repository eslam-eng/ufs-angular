...
@Component({
  ...
  templateUrl: './in-receipt.component.html',
  styleUrls: ['./in-receipt.component.scss']
})
export class InReceiptComponent extends Crud implements OnInit {

  breadcrumbList: any = [];
  title: any = "in receipts";
  companies: any = [];
  stores: any = [];
  expenseTypes: any = [];
  resource: any = {};
